...
<div class="page-header">
  <h2><i class="fas fa-edit text-expense"></i> Edit Expense</h2>
  <a href="<?= BASE_URL ?>/expenses/index.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
</div>
  ...
  <div class="card-body">
    ...
    <form method="POST" action="" novalidate>
      ...
      <div class="form-actions">
        <button type="submit" class="btn btn-warning"><i class="fas fa-save"></i> Update Expense</button>
