...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt->execute([$userId, $categoryId, 'expense', (float)$amount, $description, $date]);
...
<div class="page-header">
  <h2><i class="fas fa-plus-circle text-expense"></i> Add Expense</h2>
  <a href="<?= BASE_URL ?>/expenses/index.php" class="btn btn-secondary">
    ...
    <form method="POST" action="" novalidate>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="number" id="amount" name="amount" step="0.01" min="0.01"
                 value="<?= e($_POST['amount'] ?? '') ?>" placeholder="0.00" required>
        </div>
        <div class="form-group">
      ...
      <div class="form-group">
        ...
        <?php if (empty($categories)): ?>
          <small><a href="<?= BASE_URL ?>/categories/create.php?type=expense">Create an expense category first</a></small>
        <?php endif; ?>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea id="description" name="description" rows="3"
                  placeholder="What did you spend on?"><?= e($_POST['description'] ?? '') ?></textarea>
      </div>
